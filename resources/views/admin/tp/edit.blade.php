...
Edit Tipe Permintaan
@endsection

@section('contentheader_title')
Edit Tipe Permintaaan
@endsection
	...
	<div class="col-md-12">
		<div class="">
			<div class="box-header bg-title-form">
				<h3 class="box-title">Formulir Ubah Tipe Permintaan</h3>
			</div>
			<div class="box-body border-box">
				...
				<form role="form" method="POST" action="{{route('tp.update', $tp->id_tipe)}}" enctype="multipart/form-data">
					{!! csrf_field() !!}
                    {{ method_field('PUT') }}
                <div class="row top-22">
					<div class="col-md-12">
						<!-- <div class="form-group">
							<label>Id tp <a class="text-red">*</a></label>
							<input type="text" class="form-control" name="id_tipe"
							value="{{ $tp->id_tipe }}" required>
						</div> -->
						<div class="form-group">
							<label>Tipe Permintaan <a class="text-red">*</a></label>
							<input type="text" class="form-control" name="tp_permintaan" value="{{ $tp->tp_permintaan }}">
						</div>
						</div>
					</div>
			    </div>
