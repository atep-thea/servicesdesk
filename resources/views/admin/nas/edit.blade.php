@section('nas-link')class="active" @stop
	...
	<div class="col-md-12">
		<div class="">
			<div class="box-header bg-title-form">
				<h3 class="box-title">Formulir Ubah NAS</h3>
			</div>
			<div class="box-body border-box">
				...
				<form role="form" method="POST" action="{{route('nas.update', $nas->id_server)}}" enctype="multipart/form-data">
					{!! csrf_field() !!}
                    {{ method_field('PUT') }}
                <div class="row top-22">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="nama_perangkat" value="{{ $nas->nama_perangkat }}" required>
						</div>
						<div class="form-group">
							<label>Merek <a class="text-red">*</a></label>
							<input type="text" class="form-control" name="merek" value="{{ $nas->merek }}">
						</div>
						<div class="form-group">
							<label>Model/Type</label>
							<input type="text" class="form-control" name="model" value="{{ $nas->model }}">
						</div>
						<div class="form-group">
							<label>IP Manajemen</label>
							<input type="text" class="form-control" name="ip_manajemen" value="{{ $nas->ip_manajemen }}">
						</div>
						<div class="form-group">
							<label>Nomer Rak</label>
							<input type="text" class="form-control" name="no_rak" value="{{ $nas->no_rak }}">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<label>Aset Nomer</label>
							<input type="text" class="form-control" name="nomer_aset" value="{{ $nas->nomer_aset }}">
						</div>
						<div class="form-group">
							<label>Serial Nomer</label>
							<input type="text" class="form-control" name="nomer_serial" value="{{ $nas->nomer_serial }}">
						</div>
						<div class="form-group">
							<label>Lisensi</label>
							<input type="text" class="form-control" name="lisensi" value="{{ $nas->lisensi }}">
						</div>
						<div class="form-group">
