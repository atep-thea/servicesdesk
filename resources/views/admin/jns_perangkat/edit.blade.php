@section('jns_perangkat-link')class="active" @stop
	...
	<div class="col-md-12">
		<div class="">
			<div class="box-header bg-title-form">
				<h3 class="box-title">Formulir Ubah Nama Jenis Perangkat</h3>
			</div>
			<div class="box-body border-box">
				...
				<form role="form" method="POST" action="{{route('jns_perangkat.update', $jns_perangkat->id_jns_perangkat)}}" enctype="multipart/form-data">
					{!! csrf_field() !!}
                    {{ method_field('PUT') }}
                <div class="row top-22">
					<div class="col-md-12">
						<div class="form-group">
							<label>Id Jenis Perangkat <a class="text-red">*</a></label>
							<input type="text" class="form-control" name="id_jns_perangkat"
							value="{{ $jns_perangkat->id_jns_perangkat }}" required>
						</div>
						<div class="form-group">
							<label>Perangkat <a class="text-red">*</a></label>
							<input type="text" class="form-control" name="nama_jns_perangkat" value="{{ $jns_perangkat->nama_jns_perangkat }}">
						</div>
						</div>
					</div>
			    </div>
