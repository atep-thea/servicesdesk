...

{
...

    {
        ...
        return view('admin.accesspoint.index');

    }



    public function accpData()

    {

        $query = Server::where('id_infrastruktur','=','INF-02')->get();
        ...
        return Datatables::of($query)
                            ...
                            ->addColumn('action', function($item) {
                                ...
                                <a href=".route('accesspoint.edit', $item->id_server)." class='btn btn-xs btn-default'><i class='glyphicon glyphicon-edit'></i></a></span>";



                                $temp .= "<span data-toggle='tooltip' title='Hapus Posting'>

                                <a href='#delete' data-delete-url=".route('accesspoint.destroy', $item->id_server)." role='button' class='btn btn-xs btn-default delete'><i class='fas fa-trash-alt'></i></a></span>";
                            ...
                            ->editColumn('nama_perangkat', function($item) {
                                ...
                                return "<a href='".route('accesspoint.show', $item->id_server)."'>".$item->nama_perangkat."</a>";
...

    {
        ...
        return view('admin.accesspoint.create');
...

    {
        ...
        return redirect()->route('accesspoint.index')->with('success', 'Server "'.$request->input('nama_perangkat').'" berhasil ditambahkan!');
...

    {
        ...
        return view('admin.accesspoint.detail', $data);
...

    {
        ...
        return view('admin.accesspoint.edit', compact('server'));
...

    {
        ...
        return redirect()->route('accesspoint.index')->with('success', 'Server "'.$request->input('nama_perangkat').'" berhasil dirubah!');
...

    {
        ...
        return redirect()->route('accesspoint.index')->with('success', 'Data server "'.$server_name.'" telah dihapus!');
