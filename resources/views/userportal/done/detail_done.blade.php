<div class="modal fade" id="reqDetail" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document" style="padding:0px;width: 995px;">
    <div class="modal-content" >
      <div class="modal-header" style="    background: #4f715a;
    color: #fff;
    font-size: 15px;">
      ...
      <div class="modal-footer">
      	<form method="POST" action="{{url('close_tiket')}}" enctype="multipart/form-data">
      		{!! csrf_field() !!}
      		<input type="hidden" id="idtiket" name="idtiket" value="">
      		@if(Auth::user()->role_user != 2)
      		<button type="submit" name="close" value="Close" class="btn" style="background: #4f715a;color: #fff;"><span aria-hidden="true">Close Tiket</span></button>
      		@endif
        	<button type="button" class="btn btn-default" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><i class="fa fa-times" aria-hidden="true"></i>&nbsp;&nbsp;Cancel</span></button>
      	</form>
