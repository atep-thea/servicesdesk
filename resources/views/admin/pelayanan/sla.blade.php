	...
	<div class="col-md-12">
		<div class="">
			...
			<div class="box-body border-box">
			    ...
			    @endif
		        <form role="form" method="POST" action="{{url('update_sla')}}" enctype="multipart/form-data">
					{!! csrf_field() !!}
									...
									<div class="panel-body" style="padding: 0px;">
											<div class="row top-22">
												<div class="col-md-12">
														...
														<div class="row">
															...
															<div class="col-md-6">
																<div class="row">
																	...
																	<div class="col-sm-9">
																		<input type="text" readonly class="form-control" value="{{ $pelayanan->judul }}">
																	</div>
																</div>
															</div>
														</div>
														...
														<div class="row">
															<div class="col-md-6">
																<div class="row">
																	...
																	<div class="col-sm-9">
																		<input type="text" readonly class="form-control" value="{{ $pelayanan->opd }}">
																...
																<div class="row">
																	...
																	<div class="col-sm-9">
																		@if(empty($pelayanan->tgl_kirim_sla))
																			<input type="text" readonly class="form-control dateStart" name="tgl_kirim_sla">
																		@else
																			<input type="text" readonly class="form-control dateStart" name="tgl_kirim_sla" value="{{$pelayanan->tgl_kirim_sla}}">
																		@endif
														...
														<div class="row">
																...
																<div class="row">
																	...
																	<div class="col-sm-9">
																		@if(!empty($pelayanan->file_sla))
																			Download file SLA : <a href="{{url('downloadSla')}}/{{$pelayanan->id_}}" type="button">{{$pelayanan->file_sla}}</a>
																		@endif
																		<p></p>
															...
															<div class="col-md-6">
																<div class="row">
																	...
																	<div class="col-md-9">
																		@if(!empty($pelayanan->sla_bls))
																			Download file => <a href="{{url('downloadSLAReply')}}/{{$pelayanan->id_}}" type="button">{{$pelayanan->sla_bls}}</a>
																		@else
																...
																<div class="row">
																	...
																	<div class="col-sm-9">
																		@if(!empty($pelayanan->file_ba))
																			Download file BA : <a href="{{url('downloadBA')}}/{{$pelayanan->id_}}" type="button">{{$pelayanan->file_ba}}</a>
																		@endif
																		<p></p>
																		<input type="file" class="form-control" name="file_ba"   @if (Auth::user()->role_user == 'Eselon 3') disabled @endif>
																...
																<div class="row">
																	...
																	<div class="col-md-9">
																		@if(!empty($pelayanan->ba_bls))
																			Download file => <a href="{{url('downloadBAReply')}}/{{$pelayanan->id_}}" type="button">{{$pelayanan->ba_bls}}</a>
																		@else
																			<i style="color:red">Belum ditindak lanjuti</i>
																		@endif
																	</div>		
													...
													@if(!empty($pelayanan->komen_slaba))
													<div class="form-group">
														<div class="row">
															<div class="col-sm-12">
															...
															<div class="col-sm-12">
																<textarea style="height:75px;" class="form-control" readonly>{{$pelayanan->komen_slaba}}</textarea>
															</div>
														</div>
													</div>
													@endif
								                    	...
								                    	<div class="form-group">
															<div class="row">
																...
																<div class="col-sm-12">
																	@if(!empty($pelayanan->jwb_komen_slaba))
																		<textarea readonly style="height:75px" class="form-control">{{$pelayanan->jwb_komen_slaba}}</textarea>
																	@else 
																		<span> - </span>
																	@endif
																</div>
								                    ...
								                    <div class="form-group">
														<div class="row">
															...
															<div class="col-sm-12">
																<textarea style="height:70px" name="komen_slaba" class="form-control" @if (Auth::user()->role_user == 'Eselon 3') readonly @endif></textarea>
															</div>
														</div>
													</div>
							                    </div>
