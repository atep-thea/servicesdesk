                  ...
                  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:separate;mso-table-lspace:0pt;mso-table-rspace:0pt;width:100%;">
                    ...
                    <tr>
                      <td style="font-family:sans-serif;font-size:14px;vertical-align:top;">
                        ...
                        Hai tim helpdesk, <br>
                        <a href="http://servicedesk2.jabarprov.go.id/pelayanan"> {{ $kdTiket }} </a> baru saja dibuat.
                        </p>
                        <p>
                        ...
                        <p>
                        Klik disini untuk melihat tiket: {{ $kdTiket }} (authentication required).
                        </p>                        
                        ...
                        <br>
                        <p>
                          <center><button style="background:#076c8b;padding: 7px;border: 0px;height: 40px;width: 140px;COLOR: #FFF;border-radius: 5%;">View Website</button></center>
                        </p>
                      </td>
                    </tr>
                  </table>
