@section('jns_perangkat-list')class="active" @stop
...
$(function() {
	...
	$('#dataTable').DataTable({
        ...
        ajax: '{!! route('jns_perangkat.data') !!}',

        columns: [

            { data: 'id_jns_perangkat', name: 'id_jns_perangkat' },

            { data: 'nama_jns_perangkat', name: 'nama_jns_perangkat' },
	...
	<div class="col-md-12">
		...
		<div class="box box-primary">
			...
			<div class="box-header bg-title-box">
				...
				<h3 class="box-title">Data Jenis Perangkat</h3>

				<div class="box-tools pull-right">

					<a href="{{ route('jns_perangkat.create') }}" role="button" class="add-button btn btn-xs btn-success"><i class="fas fa-plus-circle"> Tambah</i></a>
