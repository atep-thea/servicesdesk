@section('organisation-link')class="active" @stop
...
$(function() {
	...
	$('#dataTable').DataTable({
        ...
        ajax: '{!! route('organisasi.data') !!}',

        columns: [

            { data: 'nama_opd', name: 'nama_opd' },

            { data: 'induk_organisasi', name: 'induk_organisasi' },
		...
		<div class="box box-primary">
			...
			<div class="box-header bg-title-box">
				...
				<div class="box-tools pull-right">
					...
					<a href="{{ route('organisasi.create') }}" role="button" class="add-button btn btn-xs btn-success"><i class="fas fa-plus-circle"> Tambah</i></a>
			...
			<div class="box-body border-box">
				...
				@endif
					...
					<form class="form-horizontal" action="{{ url('importOrganisasi') }}"  method="post" enctype="multipart/form-data">
