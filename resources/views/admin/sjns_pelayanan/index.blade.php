@section('sjns_pelayanan-list')class="active" @stop
...
$(function() {
	$('#dataTable').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{!! route('sjns_pelayanan.data') !!}',
        columns: [
             { data: 'id_sjns_pelayanan', name: 'id_sjns_pelayanan' },
		...
		<div class="box box-primary">
			<div class="box-header bg-title-box">
				...
				<div class="box-tools pull-right">
					<a href="{{ route('sjns_pelayanan.create') }}" role="button" class="add-button btn btn-xs btn-success"><i class="fas fa-plus-circle"> Tambah</i></a>
				</div>
			</div>
			<div class="box-body border-box">
				...
				<table class="table table-hover table-striped" id="dataTable" style="width: 100%">
					<thead class="bg-head-table">
						<tr>
							<th>Id Jenis Pelayanan</th>
							<th>Pelayanan</th>
							<th>Sub Jenis Pelayanan</th>
							<th>Action</th>
						</tr>
					</thead>
				</table>
