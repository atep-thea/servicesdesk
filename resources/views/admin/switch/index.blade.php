	...
	<div class="col-md-12">
		...
		<div class="box box-primary">
			...
			<div class="box-header bg-title-box">
				...
				<h3 class="box-title">Data Switch</h3>

				<div class="box-tools pull-right">

					<a href="{{ route('switch.create') }}" role="button" class="add-button btn btn-xs btn-success"><i class="fas fa-plus-circle"> Tambah</i></a>
