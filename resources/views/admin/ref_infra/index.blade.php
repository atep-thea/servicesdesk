@section('ref-infrastruktur-list')class="active" @stop
...
$(function() {
	$('#dataTable').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{!! route('ref-infrastruktur.data') !!}',
        columns: [
            { data: 'id_infrastruktur', name: 'id_infrastruktur' },
            { data: 'infrastruktur', name: 'infrastruktur' },
	...
	<div class="col-md-12">
		<div class="box box-primary">
			<div class="box-header bg-title-box">
				<h3 class="box-title">Data Reff Infrastruktur</h3>
				<div class="box-tools pull-right">
					<a href="{{ route('ref-infrastruktur.create') }}" role="button" class="add-button btn btn-xs btn-success"><i class="fas fa-plus-circle"> Tambah</i></a>
				</div>
			</div>
