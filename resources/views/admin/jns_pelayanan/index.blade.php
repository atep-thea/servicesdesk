		...
		<div class="box box-primary">
			...
			<div class="box-header bg-title-box">
				...
				<div class="box-tools pull-right">
					...
					<a href="{{ route('jns_pelayanan.create') }}" role="button" class="add-button btn btn-xs btn-success"><i class="fas fa-plus-circle"> Tambah</i></a>
