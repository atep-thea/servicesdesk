	...
	<div class="col-md-12">
		<div class="">
			<div class="box-header bg-title-form">
				<h3 class="box-title">Detail Hardware</h3>
			</div>
				...
				<div class="row top-22">
					<div class="col-md-8">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="nama_perangkat" value="{{ $hardware->nama_perangkat}}" readonly>
						</div>
						<div class="form-group">
							<label>Merek </label>
							<input type="text" class="form-control" name="merek" value="{{ $hardware->merek}}" placeholder="merek" readonly>
						</div>
						<div class="form-group">
							<label>Model/Type</label>
							<input type="text" class="form-control" name="model" value="{{ $hardware->model}}" placeholder="model" readonly>
						</div>
						<div class="form-group">
	                    ...
	                    <div class="form-group">
							<label>Phone</label>
							<input type="number" class="form-control" name="phone" placeholder="No HP" value="{{ $hardware->phone}}" readonly>
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
							<label>Tanggal Pembelian</label>
							<input type="text" class="form-control datepicker dateStart" name="tgl_pembelian" value="{{ $hardware->tgl_pembelian}}" readonly>
						</div>
						<div class="form-group">
							<label>Aset Nomer</label>
							<input type="text" class="form-control" name="aset_number" value="{{ $hardware->aset_number}}" placeholder="aset nomer" readonly>
						</div>
						<div class="form-group">
							<label>Serial Nomer</label>
							<input type="text" class="form-control" name="serial_number" value="{{ $hardware->serial_number}}" placeholder="serial number" readonly>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
	                        ...
	                        <textarea name="deskripsi" class="form-control" readonly>{{$hardware->deskripsi}}</textarea>
	                    </div>
	            </div>
				</div>
				<hr class="border-hr">
      		 ...
      		 <form role="form" method="POST" action="{{route('perangkat-keras.update',$hardware->id_perangkat)}}">
				...
				<div class="row top-22">
					<div class="col-md-8">
						<div class="form-group">
							<label>Jenis Perangkat Keras</label>
							<input type="text" class="form-control" name="nama_perangkat" value="{{ $hardware->jns_perangkat}}" required>
						</div>
						<div class="form-group">
							<label>Nama Perangkat <a class="text-red">*</a></label>
						...
						<div class="form-group">
							<label>Perangkat Daerah</label>
							<input type="text" class="form-control" name="nama_perangkat" value="{{ $hardware->id_organisasi}}" required>
						</div>
	                    <div class="form-group">
							<label>Phone</label>
							<input type="number" class="form-control" name="phone" placeholder="No HP" value="{{ $hardware->phone}}">
						</div>
					</div>
					<div class="col-md-4">
						<div class="form-group">
						...
						<div class="form-group">
	                        <label>Status <a class="text-red">*</a></label>
	                       <input type="text" class="form-control" name="status" value="{{ $hardware->status}}">
	                    </div>	
						<div class="form-group">
	                        <label>Keterangan </label>
