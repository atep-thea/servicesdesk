@section('reff-infrastruktur-link')class="active" @stop
@extends('layout.adminlte.app')

@section('htmlheader_title')
Input Reff Insfrastruktur
@endsection
	...
	<div class="col-md-12">
		<div class="">
			<div class="box-header bg-title-form">
				<h3 class="box-title">Formulir Tambah Ref Infrastruktur</h3>
			</div>
			<div class="box-body border-box">
		        ...
		        <form role="form" method="POST" action="{{route('ref-infrastruktur.store')}}" enctype="multipart/form-data">
					{!! csrf_field() !!}
				<div class="row top-22">
					<div class="col-md-12">
						<div class="form-group">
							<label>Id Infrastruktur <a class="text-red">*</a></label>
							<input type="text" class="form-control" name="id_infrastruktur" value="{{ old('id_infrastruktur') }}" required>
						</div>
						<div class="form-group">
							<label>Infrastruktur <a class="text-red">*</a></label>
							<input type="text" class="form-control" name="infrastruktur" value="{{ old('infrastruktur') }}">
						</div>
					</div>
				</div>
				<hr class="border-hr">
