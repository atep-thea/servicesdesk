	...
	<div class="col-md-12">
		<div class="">
			<div class="box-header bg-title-form">
				<h3 class="box-title">Formulir Tambah Perangkat jaringan</h3>
			</div>
			<div class="box-body border-box">
		        ...
		        <form role="form" method="POST" action="{{route('jaringan.store')}}" enctype="multipart/form-data">
					{!! csrf_field() !!}
