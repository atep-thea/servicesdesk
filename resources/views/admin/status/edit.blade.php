@section('status-link')class="active" @stop
	...
	<div class="col-md-12">
		<div class="">
			<div class="box-header bg-title-form">
				<h3 class="box-title">Formulir Ubah Status</h3>
			</div>
			<div class="box-body border-box">
				...
				<form role="form" method="POST" action="{{route('status.update', $status->id_status)}}" enctype="multipart/form-data">
					{!! csrf_field() !!}
                    {{ method_field('PUT') }}
                <div class="row top-22">
					<div class="col-md-12">
						<!-- <div class="form-group">
							<label>Id status <a class="text-red">*</a></label>
							<input type="text" class="form-control" name="id_status"
							value="{{ $status->id_status }}" required>
						</div> -->
						<div class="form-group">
