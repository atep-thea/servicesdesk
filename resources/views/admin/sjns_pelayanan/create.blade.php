	...
	<div class="col-md-12">
		<div class="">
			<div class="box-header bg-title-form">
				<h3 class="box-title">Formulir Tambah Jenis Pelayanan</h3>
			</div>
			<div class="box-body border-box">
		        ...
		        <form role="form" method="POST" action="{{route('sjns_pelayanan.store')}}" enctype="multipart/form-data">
					{!! csrf_field() !!}
				<div class="row top-22">
					...
					<div class="form-group">
							...
							<select class="form-control js-example-basic-single" name="id_pelayanan">
							   ...
							   @foreach($parent_org as $dataparent)
				                <option value="{{$dataparent->id_pelayanan}}">{{$dataparent->pelayanan}}</option>
				               @endforeach
	                        </select>
					...
					<div class="form-group">
							...
							<input type="text" class="form-control" name="jenis_pelayanan" value="{{ old('jenis_pelayanan') }}">
						</div>
					</div>
				</div>
				<hr class="border-hr">
