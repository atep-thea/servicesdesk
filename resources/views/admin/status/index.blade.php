@section('status-list')class="active" @stop
		...
		<div class="box box-primary">
			...
			<div class="box-header bg-title-box">
				...
				<div class="box-tools pull-right">
					...
					<a href="{{ route('status.create') }}" role="button" class="add-button btn btn-xs btn-success"><i class="fas fa-plus-circle"> Tambah</i></a>
