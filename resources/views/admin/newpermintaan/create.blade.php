@section('new-request-link')class="active" @stop
	...
	<div class="col-md-12">
		<div class="">
			...
			<div class="box-body border-box">
		        ...
		        @endforeach
		        @endif
		        <form role="form" method="POST" action="{{route('new-request.store')}}" enctype="multipart/form-data">
					{!! csrf_field() !!}
			        <div class="row">
			        	<div class="col-md-6">
											...
											<div class="row top-22">
												<div class="col-md-12">
								                    ...
								                    <div class="form-group">
								                     ...
								                     <div class="form-group">
								                        <label>Sub Sub Jenis Pelayanan </label>
								                        <select class="form-control js-example-basic-single" name="ssjns">
						                                     <option>- Sub Sub Jenis Pelayanan -</option>
						                                </select>
								                        <!--  -->
								                    </div>
								                    <div class="form-group">
								...
								<div class="panel panel-default" style="border-color: #fff !important;">
									<div class="panel-body" style="padding: 0px;">
										...
										<div class="form-group">
					                        ...
					                        <select class="form-control js-example-basic-single" name="agen_id">
					                    ...
					                    <div class="form-group">
					                        ...
					                        <input class="form-control" type="text" name="status" value="Baru" readonly>
					                    </div>
