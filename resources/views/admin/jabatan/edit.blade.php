	...
	<div class="col-md-12">
		<div class="">
			<div class="box-header bg-title-form">
				<h3 class="box-title">Formulir Ubah jabatan</h3>
			</div>
			<div class="box-body border-box">
				...
				<form role="form" method="POST" action="{{route('jabatan.update', $jabatan->id_jabatan)}}" enctype="multipart/form-data">
					{!! csrf_field() !!}
                    {{ method_field('PUT') }}
                <div class="row top-22">
					<div class="col-md-12">
						<!-- <div class="form-group">
							<label>Id jabatan <a class="text-red">*</a></label>
							<input type="text" class="form-control" name="id_jabatan"
							value="{{ $jabatan->id_jabatan }}" required>
						</div> -->
						<div class="form-group">
							<label>Jabatan <a class="text-red">*</a></label>
