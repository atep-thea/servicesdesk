...
$(function() {
	$('#dataTable').DataTable({
        ...
        serverSide: true,
        stateSave: false,
        ajax: '{!! route('pelayananDataHistoryClosed') !!}',
        search: {
	...
	<div class="col-md-12">
		<div class="box box-primary">
			<div class="box-header bg-title-box">
				...
				@if ($role != 'Verifikator PD')
				<div class="box-tools pull-right">
					<a href="{{ route('pelayanan.create') }}" role="button" class="add-button btn btn-xs btn-success"><i class="fas fa-plus-circle"> Tambah</i></a>
				</div>
				@endif
			...
			<div class="box-body border-box">
	            ...
	            <div class="row">
	            	...
	            	<div class="col-md-7" style="text-align:right"><a href="{{URL::to('export-pelayanan')}}"> <img src="{{asset('public/images/icon_excel.png')}}" width="70px" height="70px"></a></div>
	            </div>
				@endif
				</form>				
