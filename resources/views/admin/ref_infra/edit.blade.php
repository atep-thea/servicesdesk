@section('ref-infrastruktur-link')class="active" @stop
@extends('layout.adminlte.app')

@section('htmlheader_title')
Edit Ref Infrastruktur
@endsection
	...
	<div class="col-md-12">
		<div class="">
			<div class="box-header bg-title-form">
				<h3 class="box-title">Formulir Ubah Infrastruktur</h3>
			</div>
			<div class="box-body border-box">
				...
				<form role="form" method="POST" action="{{route('ref-infrastruktur.update', $refInfra->id_infrastruktur)}}" enctype="multipart/form-data">
					{!! csrf_field() !!}
                    {{ method_field('PUT') }}
                <div class="row top-22">
					<div class="col-md-12">
						<div class="form-group">
							<label>Id Infrastruktur <a class="text-red">*</a></label>
							<input type="text" class="form-control" name="id_infrastruktur"
							value="{{ $refInfra->id_infrastruktur }}" required>
						</div>
						<div class="form-group">
							<label>Infrastruktur <a class="text-red">*</a></label>
							<input type="text" class="form-control" name="infrastruktur" value="{{ $refInfra->infrastruktur }}">
						</div>
						</div>
					</div>
			    </div>
