	...
	<div class="col-md-12">
		<div class="">
			<div class="box-header bg-title-form">
				<h3 class="box-title">Formulir Tambah Urgensi</h3>
			</div>
			<div class="box-body border-box">
		        ...
		        <form role="form" method="POST" action="{{route('urgensi.store')}}" enctype="multipart/form-data">
					{!! csrf_field() !!}
				<div class="row top-22">
					<div class="col-md-12">
					<div class="form-group">
							<label>Urgensi<a class="text-red">*</a></label>
							<input type="text" class="form-control" name="def_urgensi" value="{{ old('def_urgensi') }}">
						</div>
					</div>
				</div>
				<hr class="border-hr">
