@section('urgensi-list')class="active" @stop
...
$(function() {
	...
	$('#dataTable').DataTable({
        ...
        ajax: '{!! route('urgensi.data') !!}',

        columns: [

            { data: 'id_urgensi', name: 'id_urgensi' },

            { data: 'def_urgensi', name: 'def_urgensi' },
	...
	<div class="col-md-12">
		...
		<div class="box box-primary">
			...
			<div class="box-header bg-title-box">
				...
				<h3 class="box-title">Data Urgensi</h3>

				<div class="box-tools pull-right">

					<a href="{{ route('urgensi.create') }}" role="button" class="add-button btn btn-xs btn-success"><i class="fas fa-plus-circle"> Tambah</i></a>
