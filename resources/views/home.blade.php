              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <div class="causes bg-white maxwidth500 mb-sm-30">
                    <div class="thumb">
                       <a href="{{ route('public.program.show', $last_program->slug) }}"><img width="100%" height="240" src="{{asset('photos/campaign/'.$last_program->feature_image_url)}}" alt="">
                       </a>
                  ...
                  <h5 class="font-weight-600 font-16" style="min-height: 60px"><a href="{{ route('public.program.show', $last_program->slug) }}">{{$last_program->title}}</a></h5>
                  ...
                  <ul class="list-inline font-weight-600 clearfix mt-10 pt-10">
            ...
            <div class="col-md-12">
              ...
              <div class="row">
                ...
                <div class="col-md-3 mb-30">
                  <div class="causes bg-white maxwidth500 mb-sm-30">
                    <div class="thumb">
                       <a href="{{ route('public.program.show', $campaign->slug) }}"><img width="320" height="240" src="{{asset('photos/campaign/'.$campaign->feature_image_url)}}" alt="" class="img-fullwidth">
                       </a>
                      <div class="overlay-donate-now">
